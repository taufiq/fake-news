...
# Set file names
folder = ""
file_train_instances = folder + "train_stances.csv"
file_train_bodies = folder + "train_bodies.csv"
file_test_instances = folder + "single_stance_unlabeled.csv"
file_test_bodies = folder + "single_body.csv"
file_predictions = folder + "result.txt"


def runPredictor(mode):
